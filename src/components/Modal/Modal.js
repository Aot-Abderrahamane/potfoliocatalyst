...
export default class Modal extends Component {
  render() {
    ...
    return (
      <BootstrapModal show fullscreen onHide={this.props.hide}>
        <BootstrapModal.Body className="model-style">
          <div className="container-fluid">
            <div className="row ">
              ...
              <button
                ...
                aria-label="Close"
                onClick={this.props.hide}></button>
            </div>
            <div className="row " style={{ textAlign: 'start' }}>
              <div className="row  ">
                <div className="col">
                  <HeadModal className="modal-heading">
                    Aperçu général{' '}
                  </HeadModal>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <h2>
                    <span style={{ backgroundColor: '#000', color: 'azure' }}>
                    ...
                    {this.props.stack.map((stack, i) => (
                      <>
                        <li
                          ...
                          key={i}
                          style={{ fontSize: '20pt', color: 'azure' }}>
                          <i
